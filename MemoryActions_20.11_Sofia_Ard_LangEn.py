...
# Kamil
LANG = {
    'text_instr2':"Press button 'A' to continue", 
    'signal':"go",
    'question':"Which object was closer to the cross?\n\n'A'   triangle\n'B'   square",
    'text_end_block':"Press button 'A' to continue\n\n",
    'text_thanks':"The experiment ended.\n\nThank you for your participation!",
    'textInstr1':"Move the joystick to the closest circle",
    'textInstr2':"Move the joystick to the closest object and also pay attention to which object was it: triangle or square",
    'textInstr3':'Remember which circle is closer to the cross. \n\nWhen you see a signal (word "go"), move the joystick to its supposed location.',
    'textInstr4':'Remember which object is closer to the cross and what object is it : triangle or square. \n\nWhen you see a signal (word "go"), move the joystick to its supposed location.',
    'msqFeedback1':"Correct",
    'msqFeedback2':"Wrong",
    'textScore1':"Score",
    'textScore2':"correct hits",
    'textScore3':"from",
    'textScore4':"trials",
    'textScore5':"reaction time",
    'textScore6':"missed trials",
    'textScore7':"correct answers on the question"
}
#----------------------------->
